...
MODELS = {
    ...
    'Gemma 系列': [
        ...
        ('LLM-Research/gemma-4-1b-pt', 'Gemma-4-1B'),
        ('LLM-Research/gemma-4-4b-pt', 'Gemma-4-4B'),
        ('LLM-Research/gemma-4-12b-pt', 'Gemma-4-12B'),
        ('LLM-Research/gemma-4-27b-pt', 'Gemma-4-27B'),
        ('LLM-Research/gemma-4-1b-it', 'Gemma-4-1B-Instruct'),
        ('LLM-Research/gemma-4-4b-it', 'Gemma-4-4B-Instruct'),
        ('LLM-Research/gemma-4-12b-it', 'Gemma-4-12B-Instruct'),
        ('LLM-Research/gemma-4-27b-it', 'Gemma-4-27B-Instruct'),
